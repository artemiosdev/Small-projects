...
- **[UITextView, UIStepper, UIActivityIndicatorView, UIProgressView](https://github.com/artemiosdev/Small-projects/tree/main/UITextView/UITextView)**, пример использования [UITextView ](https://developer.apple.com/documentation/uikit/uitextview)
